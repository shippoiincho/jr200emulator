...
#define TXCOUNT (320*200/2) // Total pixels/2 (since we have 2 pixels per byte)

#define TXCOUNT_LINE 160 // Total pixels/2 for 1 line (since we have 2 pixels per byte)
